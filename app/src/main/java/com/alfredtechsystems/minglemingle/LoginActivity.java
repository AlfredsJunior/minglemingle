...
public class LoginActivity extends AppCompatActivity {
    ...
    private void facebookPermissionsRequiredAlert() {
        ...
        String message = "MingleMingle requires you to provide additional Facebook permissions in order to create or use this service. This information is for your and other users' safety, provides more authenticity to profiles, and allows us to better provide support.";
